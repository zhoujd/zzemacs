...
(custom-theme-set-faces
 ...
 ;; helm
 `(helm-M-x-key ((t (:foreground "#ff5f87" :underline t))))
 `(helm-buffer-size ((t (:foreground "#efc334"))))
 `(helm-buffer-not-saved ((t (:foreground "#efc334"))))
 `(helm-buffer-saved-out ((t (:foreground "red" :inverse-video t))))
 `(helm-visible-mark ((t (:background "#333" :foreground "#FF6400" :bold t))))
 `(helm-header ((t (:inherit header-line))))
 `(helm-separator ((t (:foreground "red"))))
 `(helm-buffer-directory ((t (:foreground "#FF6400"))))
 `(helm-ff-directory ((t (:foreground "#FF6400"))))
 `(helm-ff-symlink ((t (:foreground "#f6df92"))))
 `(helm-ff-prefix ((t (:foreground "#ff5f87" :weight bold))))
 `(helm-source-header ((t (:foreground "#F8F8F8" :underline t :weight bold))))
