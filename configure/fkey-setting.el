...
(apply-keys-to-map
 ...
 (list
  ...
  (kbd "S-1")       (lookup-key global-map [S-f1])
  (kbd "S-2")       (lookup-key global-map [S-f2])
  (kbd "S-3")       (lookup-key global-map [S-f3])
  (kbd "S-4")       (lookup-key global-map [S-f4])
  (kbd "S-5")       (lookup-key global-map [S-f5])
  (kbd "S-6")       (lookup-key global-map [S-f6])
  (kbd "S-7")       (lookup-key global-map [S-f7])
  (kbd "S-8")       (lookup-key global-map [S-f8])
  (kbd "S-9")       (lookup-key global-map [S-f9])
  (kbd "S-0")       (lookup-key global-map [S-f10])
  (kbd "S--")       (lookup-key global-map [S-f11])
  (kbd "S-=")       (lookup-key global-map [S-f12])
