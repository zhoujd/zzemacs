...
# URL: https://github.com/libstatgrab/libstatgrab-ci/blob/master/gitlab-runner-shim.sh
# Download the script and rename to gitlab-runner and put it into /usr/bin, then it should work
