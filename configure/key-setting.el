...
;;F1-F12 functions setting
(global-set-key [S-f1]   'vm)
(global-set-key [C-f1]   'recentf-open-files)
...
(global-set-key [M-S-f8] 'gud-tooltip-mode)
...
(global-set-key [M-S-f9] 'popup-term)
