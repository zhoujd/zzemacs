...
use 5.008;                      # try to defend against "Modern"
$VERSION = '0.992_01';
BEGIN {
    if ($] >= 5.012) {
...
sub define_shortcuts
{
    define_shortcut 'help', \&Sepia::repl_help,
        'help [CMD]',
            'Display help on all commands or CMD.';
    ...
    define_shortcut 'format', \&Sepia::repl_format,
        'format [TYPE]', "Set output format to TYPE ('dumper', 'dump', 'yaml', or 'plain'; default: 'dumper') or show current type.";
