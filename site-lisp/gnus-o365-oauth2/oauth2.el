...
(defun oauth2-read-authorization-string ()
  "Ask for the authorization string from the user."
  (read-string "Enter the code your browser displayed: "))

(defun oauth2-request-authorization (auth-url client-id &optional scope state redirect-uri read-authorization-string)
...
It returns the code provided by the service."
  ...
  (funcall (or read-authorization-string #'oauth2-read-authorization-string)))
...
;;;###autoload
(defun oauth2-auth (auth-url token-url client-id client-secret &optional scope state redirect-uri read-authorization-string)
  ...
  (oauth2-request-access
   ...
   (oauth2-request-authorization
    auth-url client-id scope state redirect-uri read-authorization-string)
   redirect-uri))
...
;;;###autoload
(defun oauth2-auth-and-store (auth-url token-url scope client-id client-secret &optional redirect-uri state read-authorization-string)
